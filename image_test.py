...
class TestOCRAccuracy(unittest.TestCase):
    EXPECTED_VALUES = {
        ...
        'test5.jpg': {'칼로리': 365, '탄수화물': 67, '지방': 8.3, '단백질': 8},
        'test6.jpg': {'칼로리': 446, '탄수화물': 99, '지방': 4, '단백질': 7},
        'test7.jpg': {'칼로리': 505, '탄수화물': 84, '지방': 22, '단백질': 9},
        'test8.jpeg': { '칼로리': 200, '탄수화물': 43, '지방': 11.2, '단백질': 4},
        'test9.jpeg': {'칼로리': 525, '탄수화물': 69, '지방': 36, '단백질': 6},
        #'test10.jpeg': { '칼로리': 510, '탄수화물': 52, '지방': 32, '단백질': 3},
